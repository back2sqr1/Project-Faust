...
\newcommand{\handout}[5]{
  ...
  \framebox{
    \vbox{
      \hbox to 5.78in { {\bf 6.841: Advanced Complexity Theory } \hfill #2 }
      \vspace{4mm}
...
\topic{NUMBER --- DATE, 2012}{Fall 2012}{Prof.\ Dana Moshkovitz}{YOUR NAME}

\section{Overview}

In the last topic we \ldots.

In this topic we \ldots.
